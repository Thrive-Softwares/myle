...
import 'package:myle/nothing/pages/settings_page.dart';
import 'package:myle/nothing/pages/start_page.dart';
...
class BrowserHomeNothing extends StatefulWidget {
  const BrowserHomeNothing({super.key});

  @override
  State<BrowserHomeNothing> createState() => _BrowserHomeNothingState();
}

class _BrowserHomeNothingState extends State<BrowserHomeNothing> {
